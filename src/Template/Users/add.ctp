                    ...
                    <div class="ibox float-e-margins tabs-container">
                        ...
                        <div class="ibox-content tab-content">
                             <div id="tab-1" class="tab-pane active">
                                    ...
                                    <?= $this->Form->create($user, ['id' => 'Admin-AddUser']) ?>
                                    <div class ="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class ="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group"><label class="col-sm-12 ">Role</label>
                                                <div class="col-sm-12">
                                                    <?php  echo $this->Form->control('role',['multiple' => false,'empty' => 'Please select Role','options' => @$role_data,'type' => 'select','class' => 'select2_demo_1 form-control','label' => false]); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class ="row">
                                        <div class="col-md-6">
                                           <div class="form-group"><label class="col-sm-12 ">Password</label>
                                                <div class="col-sm-12">
                                               <?php echo $this->Form->input('password', ['type' => 'password','class' => 'form-control', 'placeholder' => 'Password', 'label' => false]); ?>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                           <div class="form-group"><label class="col-sm-12 ">Confirm Password</label>
                                                <div class="col-sm-12">
                                               <?php echo $this->Form->input('confirm_password', ['type' => 'password','class' => 'form-control', 'placeholder' => 'Confirm Password', 'label' => false]); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
