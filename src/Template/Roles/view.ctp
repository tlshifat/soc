                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title ">
                            ...
                            <span>
                                ...
                                <?= $this->Html->link(__('Edit'), ['action' => 'edit', $role->id],['data-toggle' =>'tooltip','data-placement' => 'bottom', 'title' =>'Edit','class' => 'btn btn-success btn-xs pull-right back-btn']) ?>   
                            </span>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <dl class="dl-horizontal">
                                        <dt><?= __('Title') ?>:</dt> <dd><span class="label label-primary"><?= h($role->role) ?></span></dd>
                                    </dl>
                                </div>
                                <div class="col-lg-6">
                                    <dl class="dl-horizontal">
